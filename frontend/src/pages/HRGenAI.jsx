...
const HRGenAI = ({ onNewChat }) => {
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      const aiResponse = {
        sender: "bot",
        text: `You asked about "${input}". I’ll find relevant HR insights for you.`,
      };
      ...
      <main className="flex-1 flex flex-col">
        ...
        {!["dashboard","employees","recruitment","performance","analytics"].includes(activeTab) && (
          <div className="p-8 flex flex-col gap-6">
            ...
            {/* Chat Box */}
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-inner h-[480px] flex flex-col">
